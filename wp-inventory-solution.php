...
/*
Plugin Name: wp-inventory-solution
Plugin URI: #
Description: This is a basically inventory and a minor part of commerce solution.
Version: 1.0.0
Author: Nitesh Das
Author URI: #
...
if (!defined('PLUGINNAME_VERSION')) {
    ...
    define('PLUGINNAME_UPLOAD_DIR', '/wp-grocery');
